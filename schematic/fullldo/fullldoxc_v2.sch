...
C {PDK/sky130A/libs.tech/xschem/sky130_fd_pr/cap_mim_m3_1.sym} 210 -70 0 0 {name=C2 model=cap_mim_m3_1 W=10 L=10 MF=24 spiceprefix=X}
C {devices/lab_pin.sym} 210 -40 1 1 {name=p20 sig_type=std_logic lab=vss}
C {devices/lab_pin.sym} 210 -100 0 1 {name=p21 sig_type=std_logic lab=gate}
C {PDK/sky130A/libs.tech/xschem/sky130_fd_pr/cap_mim_m3_1.sym} 370 -62.5 0 0 {name=C1 model=cap_mim_m3_1 W=5 L=5 MF=1 spiceprefix=X}
C {devices/lab_pin.sym} 370 -32.5 1 1 {name=p4 sig_type=std_logic lab=vss}
C {devices/lab_pin.sym} 370 -92.5 0 1 {name=p16 sig_type=std_logic lab=vref}
