...
C {PDK/sky130A/libs.tech/xschem/sky130_fd_pr/cap_mim_m3_1.sym} 370 -60 0 0 {name=C1 model=cap_mim_m3_1 W=5 L=5 MF=1 spiceprefix=X}
C {devices/lab_pin.sym} 370 -30 1 1 {name=p16 sig_type=std_logic lab=vss}
C {devices/lab_pin.sym} 370 -90 0 0 {name=p22 sig_type=std_logic lab=vref}
